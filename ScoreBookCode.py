...
for game in games:
    ...
    '''
    agg_functions = {"PA" : 'sum', "Single": 'sum', "Double": 'sum', "Triple": 'sum', "Home Run": 'sum', "RBI": 'sum',"R": 'sum',"Fielder's Choice": 'sum',"Fly Out": 'sum',"Pop Out": 'sum',"Ground Out": 'sum', "Line Out": 'sum', "Strike Out": 'sum',"SAC": 'sum',"Skips": 'sum'}
    gamebook = gamebook.groupby('Name').aggregate(agg_functions)
    '''

    #Scores, wins, losses. Future notes: Should be able to combine into one function?
    print(playerlistVisitor)
