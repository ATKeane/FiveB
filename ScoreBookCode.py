...
#The function and shifting are to allow for one program to run everything at once.
#This is commented so I don't ruin everything.
#week = input("What week is this being run for? (Use an integer to describe)")
def ScoreBookCode(week):
    week = "Week" +str(week)
    games = ["Game1","Game2"]
    ...
    for game in games:
        ...
        def atbatresults(playerlist, batternumber,playerdict,TeamStats,plate_appearance_dict, plate_appearance_id):
            ...
            while outs <3:
                ...
                #Making Plate Appearance score a string
                plate_appearance_score = str(plate_appearance_score)

                #Isolating the hit/out type.
                print(plate_appearance_id)
                print(currentbatter)
                print(plate_appearance_score)
